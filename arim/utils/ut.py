...
__all__ = ['fmc', 'hmc', 'infer_capture_method', 'decibel', 'directivity_finite_width_2d',
           'fluid_solid', 'solid_l_fluid', 'solid_t_fluid', 'snell_angles']
...
def fluid_solid(alpha_fluid, rho_fluid, rho_solid, c_fluid, c_l, c_t, alpha_l=None, alpha_t=None):
    ...
    .. [KK] Krautkrämer, Joseph, and Herbert Krautkrämer. 1990.
            Ultrasonic Testing of Materials. 4th, 1990 ed. Springer-Verlag Berlin Heidelberg.
            http://link.springer.com/book/10.1007/978-3-662-10680-8.
