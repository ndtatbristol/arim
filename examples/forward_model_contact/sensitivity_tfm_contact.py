"""
TFM sensitivity in contact inspection using a single-frequency LTI model.

Not finished, not validated. Buyer beware.
"""
...
def compute_sensitivity(dataset_name, save):
    ...
    aplt.plot_interfaces(
        [probe_p, *examination_object.walls.values(), grid_p],
